...
//Outside Module
//retrieved from https://github.com/zerokol/JoystickView
...
public class JoyStick extends View implements Runnable {
    ...
    protected void initJoystickView() {
        ...
        mainCircle.setColor(ColorPallete.Magnolia);
        mainCircle.setStyle(Paint.Style.FILL_AND_STROKE);

        secondaryCircle = new Paint();
        secondaryCircle.setColor(ColorPallete.Xiketic);
        ...
        button.setColor(ColorPallete.HanPurple);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (abs > buttonRadius) {
            xPosition = (int) ((xPosition - centerX) * buttonRadius / abs + centerX);
            yPosition = (int) ((yPosition - centerY) * buttonRadius / abs + centerY);
        }
        invalidate();
    ...
    private int getPower() {
        return (int) (100 * Math.sqrt((xPosition - centerX)
                ...
                * (yPosition - centerY)) / buttonRadius);
    }
