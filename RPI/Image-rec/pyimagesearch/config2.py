...
BASE_PATH = "dataset+"
POSITVE_PATH = os.path.sep.join([BASE_PATH, "01_up"])
NEGATIVE_PATH = os.path.sep.join([BASE_PATH, "no_01_up"])
...
MODEL_PATH = "image_detector_small+.h5"
ENCODER_PATH = "label_encoder_small+.pickle"
